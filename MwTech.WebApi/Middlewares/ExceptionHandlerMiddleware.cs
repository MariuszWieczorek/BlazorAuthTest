...
namespace MwTech.WebApi.Middlewares;
...
public class ExceptionHandlerMiddleware
{
    ...
    private static Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        if (exception is MwTech.Application.Common.Exceptions.ValidationException)
        {
            var ex = exception as MwTech.Application.Common.Exceptions.ValidationException;
