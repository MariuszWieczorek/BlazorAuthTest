...
public class CompleteMaterialRequestCommandHandler : IRequestHandler<CompleteMaterialRequestCommand>
{
    ...
    public CompleteMaterialRequestCommandHandler(IScadaIfsDbContext scadaContext,
    ...
    public async Task Handle(CompleteMaterialRequestCommand request, CancellationToken cancellationToken)
    {
