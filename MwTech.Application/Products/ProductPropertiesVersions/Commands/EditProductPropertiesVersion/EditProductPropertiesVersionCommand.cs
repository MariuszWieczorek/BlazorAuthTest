...
public class EditProductPropertiesVersionCommand : IRequest
{
    ...
    [Display(Name = "Domyślna w IFS")]
    public bool IfsDefaultVersion { get; set; }

    [Display(Name = "Domyślna w Comarch")]
    ...
    [Required(ErrorMessage = "Pole 'Nazwa Wariantu' jest wymagane")]
