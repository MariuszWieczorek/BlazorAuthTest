...
public class IfsProductRecipeConfiguration : IEntityTypeConfiguration<IfsProductRecipe>
{
    public void Configure(EntityTypeBuilder<IfsProductRecipe> builder)
    {
